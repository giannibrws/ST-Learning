                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    ...
                                    <p>
                                        Structured learning is an online platform to create your own study environment specifically
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ml-2 underline">
                                FAQ
                            </a>
                            <i class="ml-4 fas fa-book text-gray-400"></i>
                            <a href="/privacy-policy" class="ml-1 underline">
                                Privacy-Policy
                            </a>
                        </div>
                    </div>
