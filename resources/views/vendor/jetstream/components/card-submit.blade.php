<div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8">
    <div class="flex items-center px-5 py-12 shadow-sm rounded-md bg-white">
        ...
        <div class="mx-5">
            <form  content="<?= csrf_token() ?>" method="POST" action="<?=route('classrooms.store')?>">
                <div class="st-input">
                    ...
                    <button class="text-white bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" type="submit">Add classroom</button>
                </div>
            </form>
        </div>
    </div>
