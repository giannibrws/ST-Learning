    {{--Start card:--}}
    <div class="w-full px-6 sm:w-1/2 xl:w-1/3 mb-8" id="cr_card_submit">
        <div class="st-item-flex st-card st-card--classroom shadow-sm">



    <div class="st-card__content">

            <svg class="p-3 rounded-full bg-indigo-600 bg-opacity-75 h-12 w-12 text-white st-card__icon" viewBox="0 0 28 30" fill="none"
