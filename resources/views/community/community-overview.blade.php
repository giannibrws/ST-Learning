<x-app-layout>
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-auto bg-gray-200">
        <x-jet-nav-sidebar>
            <x-slot name="url">{{"Community"}}</x-slot>
        </x-jet-nav-sidebar>
        ...
        <div class="w-full">
            ...
            <main class="overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container py-8 mx-auto">
                    <div class="st-card st-card--headers">
                        <h3 class="text-gray-700 text-3xl font-bold font-medium text-center">Community</h3>
                        <p class="">Explore & discover trending boards:</p>
                    </div>
