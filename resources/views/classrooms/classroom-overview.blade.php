                ...
                <main class="overflow-x-hidden overflow-y-auto bg-gray-200">
                    ...
                    <div class=" container mx-auto px-6 py-8">
                        <h3 class="text-gray-700 text-3xl font-bold font-medium text-center">Dashboard</h3>
                            ...
                            <div class="-mx-6 mt-4 flex flex-wrap" id="dynamic_cr_results">
                        ...
                        <div class="-mx-6 mt-4 flex flex-wrap" id="cr_card_submit">

                            {{--Start card:--}}
                            <div class="w-full px-6 sm:w-1/2 lg:w-1/2 xl:pr-0 xl:w-1/4 xl:mr-11 xl:absolute xl:right-20 xl:bottom-20 xl:-mb-20 ">
